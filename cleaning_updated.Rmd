...
##Part 2: Add Survey Data - all 


###Read in the dataset
```{r}

survey_all <- read_csv(here("survey_data", "baseline_cropburning_plotlevel.csv")) ##this won't run, missing this data
...
#read in the spatial polygon file - note 5/11, this is all from the project on the desktop

polygons <- read_sf(here(dsn = "clean_shapefiles_arc"), layer = "clean_1")
...
st_write(clean_poly_everything, "polygons_with_survey.shp") #this wasn't working well 
